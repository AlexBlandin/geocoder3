...
options = {
  ...
  "geonames": {"geocode": GeonamesQuery, "details": GeonamesDetails, "timezone": GeonamesDetails, "children": GeonamesChildren, "hierarchy": GeonamesHierarchy},
  ...
  "bing": {"geocode": BingQuery, "details": BingQueryDetail, "reverse": BingReverse, "batch": BingBatchForward, "batch_reverse": BingBatchReverse},
  "google": {
    "geocode": GoogleQuery,
