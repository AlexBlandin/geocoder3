...
def test_geonames_geojson(geonames_response):
  ...
  with open(geojson_file, encoding="utf8") as geojson_stream:
...
def test_details():
  ...
  with requests_mock.Mocker() as mocker, open(data_file, encoding="utf8") as input:
    ...
    assert g.bbox == {"northeast": [45.58753415000007, -75.07957784899992], "southwest": [44.962202955000066, -76.35400795899994]}
